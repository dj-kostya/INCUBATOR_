    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.LOG_IN_3_2_1',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 3;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.EDIT_USER_3_2_2',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 2;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.DEL_USER_3_2_3',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 2;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.ADD_DELIVERY_3_2_5',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 3;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.GET_ORDERS_3_2_6',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            p_status := 2;
            RETURN NULL;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.GET_ORDERS_3_2_6_JSON',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            p_status := 2;
            RETURN NULL;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.GET_ORDERS_3_2_6_PIPE',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            p_status := 2;
            RETURN;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.ADD_ORDER_3_2_7',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 1;
    END;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.USERS_3_2.DEL_ORDER_3_2_7',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 1;
    END;
...
AS
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.WAREHOUSE_3_3.ADD_WAREHOUSE_3_3_1',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 1;
    END;
    ...
    BEGIN
        SELECT SUM (r.QUANTITY)
          INTO v_quantity
          FROM student4.remnants  r
               JOIN student4.WAREHOUSES w ON w.ID_WAREHOUSE = r.ID_WAREHOUSE
         WHERE     w.del_date IS NULL
               AND p_id = w.ID_WAREHOUSE
               AND r.del_date IS NULL;
    ...
    EXCEPTION
        ...
        THEN
            p_message :=
                ...
                || SQLERRM;
            STUDENT4.add_logs (
                P_FUNCTION   => 'STUDENT4.WAREHOUSE_3_3.DEL_WAREHOUSE_3_3_1',
                P_TEXT_ERR   => TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 3;
    END;
    ...
    EXCEPTION
        ...
        THEN
            ...
            STUDENT4.add_logs (
                P_FUNCTION =>
                    'STUDENT4.WAREHOUSE_3_3.TRANS_FROM_WAREHOUSE_3_3_3',
                P_TEXT_ERR =>
                    TO_CHAR (SQLCODE) || ' - ' || SQLERRM);
            RETURN 2;
